...
# #             conn.sendall(packets[next_seq][1])
# #             timers[next_seq] = time.time()
# #             print(f"[SERVER] Sent Packet {next_seq}")
# #             next_seq += 1
...
# #                         print(f"[SERVER] Fast retransmit Packet {resend_seq}")
...
# #                     print(f"[SERVER] Timeout retransmit Packet {seq}")
